...
?>
    <div class="bdls-comments">
        <h2 class="bdls-postheader nocomments"><?php _e('This post is password protected. Enter the password to view any comments.', THEME_NS) ?></h2>
    </div>
<?php
	return;
}
...
?>
    <div class="bdls-comments">
        <h2 class="bdls-postheader comments"><?php printf(
...
echo str_replace(
    ...
    array('id="respond" class="bdls-commentsform"', '<h2', 'id="reply-title" class="bdls-postheader"', '</h2>', 'bdls-postcontent logged-in-as', 'class="bdls-button" type="submit"'), 
    theme_ob_get_clean());